...
%LAST COL CONTAINS TOT # OF STEPS
...
MetricsPath = './MetricsData/Patients/R08/'; %folder where Avg Results per test are saved
MetricsPathDet = './MetricsData/Patients/R08/Detailed/'; %folder for each walk section results
datapathTT = './TestTimes/Patients/R08/'; %datapath of TestTimes Data
datapathacc = './TestTimes/Patients/R08/Rawaccdata/'; %datapath of raw acc data
...
%         
        ...
        %last col of last row contains tot # of steps 
        MetricsTMP(end,7)=sum(MetricsTMP(1:end-1,6));
